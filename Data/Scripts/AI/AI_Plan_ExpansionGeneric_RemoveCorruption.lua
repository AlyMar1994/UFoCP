	...
	TaskForce = {
		{
			"MainForce",
			"DenyHeroAttach",
			"Mon_Mothma_Team | Obi_Wan_Team | Katarn_Team | Yoda_Team | Luke_Jedi_XWing | Millennium_Falcon | Emperor_Palpatine_Team | General_Veers_Team | Darth_Team_Executor | Mara_Jade_Team | Admonitor_Star_Destroyer | Home_One = 1"
		}
	}
end
