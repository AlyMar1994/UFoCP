-- $Id: //depot/Projects/StarWars_Steam/FOC/Run/Data/Scripts/Library/PGSpawnUnits.lua#1 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars_Steam/FOC/Run/Data/Scripts/Library/PGSpawnUnits.lua $
--
			...
			elseif block.block.IsFinished() then
				...
				if type(new_units) == "table" then
					for j, unit in pairs(new_units) do
						DebugMessage("%s -- Process_Reinforcements Block: %s, unit: %s, allow:%s, delete:%s",
										tostring(Script), tostring(block.block), tostring(unit), tostring(block.allow_ai_usage), tostring(block.delete_after_scenario))
