...
function State_Empire_M09_Begin(message)
	...
	if message == OnEnter then
		...
		if not TestValid(emperor_palpatine) then
			DebugMessage("Couldn't find the emperor!!!")
			ScriptExit()
		end
		...
		if not TestValid(guard_palpatine_1) then
			DebugMessage("Couldn't find emperors first guard!!!")
			ScriptExit()
		end
		...
		if not TestValid(guard_palpatine_2) then
			DebugMessage("Couldn't find emperors second guard!!!")
			ScriptExit()
		end
		...
		if not TestValid(bothan_1) then
			DebugMessage("Couldn't find the first bothan!!!")
			ScriptExit()
		end
		...
		if not TestValid(bothan_2) then
			DebugMessage("Couldn't find the second bothan!!!")
			ScriptExit()
		end
		...
		if not TestValid(bothan_3) then
			DebugMessage("Couldn't find the third bothan!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_shuttle_pos) then
			DebugMessage("Couldn't find the emperor's shuttle position!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_move_to_pos_1) then
			DebugMessage("Couldn't find the emperor's first move to position!!!")
			ScriptExit()
		end

		emperor_move_to_pos_2 = Find_Hint("GENERIC_MARKER_LAND", "emperormoveto2")
		if not TestValid(emperor_move_to_pos_2) then
			DebugMessage("Couldn't find the emperor's second move to position!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_end_cinematic_start) then
			DebugMessage("Couldn't find the emperor's end cinematic start position!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_end_cinematic_end) then
			DebugMessage("Couldn't find the emperor's final cinematic position!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_guard_move_to_pos_1) then
			DebugMessage("Couldn't find the first emperor's guard's move to position!!!")
			ScriptExit()
		end
		...
		if not TestValid(emperor_guard_move_to_pos_2) then
			DebugMessage("Couldn't find the second emperor's guard's move to position!!!")
			ScriptExit()
		end
		...
		if not TestValid(bothan_2_run_to_pos) then
			DebugMessage("Couldn't find the second bothans run to position!!!")
			ScriptExit()
		end
		...
		if not TestValid(bothan_3_run_to_pos) then
			DebugMessage("Couldn't find the third bothans run to position!!!")
			ScriptExit()
		end
		...
		if not emperor_tyderium_shuttle then
			DebugMessage("Couldn't create the emperors shuttle!!!")
			ScriptExit()
		end
